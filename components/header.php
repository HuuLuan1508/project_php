<header class="p-3" style="background-image: url('https://nettruyenrr.com/public/assets/images/bg_header_2017.jpg'); background-size: cover; color: white;">
        ...
        <div class="row align-items-center">
            <div class="col-6 d-flex align-items-center gap-4">
                ...
                <ul class="nav-menu d-none d-lg-flex gap-3 align-items-center m-0 p-0">
                    ...
                    <li><a href="/PROJECT_PHP/pages/favourite.php" style="color: white;">Sách Yêu Thích</a></li>
                ...
                <ul class="d-flex gap-3 align-items-center justify-content-end m-0 p-0 ">
                    <li>
                        <div class="position-relative">
                            <input class="input_search form-control pe-5" type="text" placeholder="Hôm nay bạn tìm gì nò..." style="color: black;">
                            <i class="fa-solid fa-magnifying-glass position-absolute top-50 end-0 translate-middle-y me-2" style="color: black;"></i>
                        </div>
                    </li>

                    <li>
                        <a class="d-flex align-items-center gap-2" href="#" style="color: white;">
